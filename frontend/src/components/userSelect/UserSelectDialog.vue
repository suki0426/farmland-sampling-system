<template>
  <div>
    <el-dialog title="用户选择" width="1200px" :close-on-click-modal="false" :append-to-body="true" v-dialogDrag
        ...
        <el-container>
          <el-header style="text-align: left; font-size: 12px;height:30px">
            <el-form size="small" :inline="true" ref="searchForm" :model="searchForm" @keyup.enter.native="refreshList()"
              ...
              <el-form-item>
                <el-button type="primary" @click="searchOne()" size="small" icon="el-icon-search">查询</el-button>
          ...
          <el-main>
            <el-table :data="dataList" v-loading="loading" size="small" border ref="userTable"
              @selection-change="selectionChangeHandle" @sort-change="sortChangeHandle" height="calc(100% - 80px)"
              style="width: 100%;">
              <el-table-column header-align="center" align="center" v-if="limit <= 1" width="60">
