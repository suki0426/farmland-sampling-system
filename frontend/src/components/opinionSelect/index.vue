<template>
  <div class="box" v-if="isVisibleBtn">
    <!-- <el-button type="primary" slot="append" :disabled="disabled" @click="showSelectDialog" icon="el-icon-circle-plus-outline">选择专家问题</el-button> -->
    <el-dialog :title="title" :close-on-click-modal="false" :append-to-body="true" v-dialogDrag class="gridDialog"
        ...
        <el-col :span="24">
          ...
          <el-table :data="dataList" v-loading="loading" size="small" ref="gridTable" height="400px" border
            ...
            <template v-for="(column, index) in columns">
              <el-table-column :key="index" :prop="column.prop" header-align="center" align="center" min-width="100px"
                :label="column.label">
              </el-table-column>
            </template>
          </el-table>
