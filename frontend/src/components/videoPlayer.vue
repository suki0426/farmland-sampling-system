      ...
      return {
        ...
        playOptions: {
          ...
          sourceOrder: true,
            ...
            //      src: 'http://127.0.0.1/hls/movie.m3u8'
            //    }
            //  ],
          sources: [
            {
              type: this.actionEvent === 'viewLive' ? 'application/x-mpegURL' : 'video/mp4', // 类型 'video/mp4'
              src: this.videoUrl // require("./1.mp4"), // url地址，在使用本地的资源时，需要用require()引入，否则控制台会报错
            }
               // {
               //   withCredentials: false,
               //   type: 'video/x-flv',
               //   src: 'rtmp://127.0.0.1:1935/live/stream'
               // }
          ],
            //  flash: {
