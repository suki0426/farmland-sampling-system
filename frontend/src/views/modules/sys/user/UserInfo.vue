<template>
  <div class="user-info el-scrollbar__wrap wrap-white padding-20">
    <div class="el-scrollbar__view">
      <el-tabs tab-position="left">
        <el-tab-pane label="基本信息">
          <h3 style="margin-left:40px;margin-bottom: 30px;">基本信息</h3>
        ...
        <el-tab-pane label="联系方式">
          <h3 style="margin-left:40px;margin-bottom: 30px;">联系方式</h3>
        ...
        <el-tab-pane label="我的头像">
          <el-form :model="photoForm" ref="photoForm" label-width="100px">
            <el-form-item prop="photo">
              <image-select v-model="photoForm.photo" round icon="el-icon-s-custom" title="头像"></image-select>
            </el-form-item>
            <el-form-item>
              <el-button style="width: 148px" type="primary" size="small" @click="submitPhotoForm()">保存</el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
        <el-tab-pane label="修改密码">
          <h3 style="margin-left:40px;margin-bottom: 30px;">修改密码</h3>
          <el-form size="small" :model="pwdForm" ref="pwdForm" label-width="150px">
            <el-form-item label="旧密码" :rules="[{ required: true, message: '必填项不能为空', trigger: 'blur' }]"
              prop="oldPassword">
              <el-input v-model="pwdForm.oldPassword" show-password></el-input>
            </el-form-item>
            <el-form-item label="新密码" :rules="[{ required: true, message: '必填项不能为空', trigger: 'blur' }]"
              prop="newPassword">
        ...
        <el-tab-pane label="我的日志">
          ...
          <vxe-table border="inner" auto-resize resizable height="500px" :loading="loading" size="small" ref="logTable"
...
<style scoped>
.user-info.el-scrollbar__wrap {
    overflow: auto !important;
    height: 100% !important;
    background-color: #fff !important;
    border: 0px solid transparent !important;
    border-radius: 1.25rem !important;
    -webkit-box-shadow: 0px 12px 23px 0px rgba(92, 55, 153, 0.04) !important;
    box-shadow: 0px 12px 23px 0px rgba(92, 55, 153, 0.04) !important;
