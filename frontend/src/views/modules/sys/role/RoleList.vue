<template>
  <div class="ultra-theme ultra-table-page">
    <el-form size="small" :inline="true" ref="searchForm" class="ultra-query-form" :model="searchForm" @keyup.enter.native="refreshList()" @submit.native.prevent>
    ...
    <div class="ultra-table-panel">
     ...
     <div class="ultra-table-stage">
          ...
          <vxe-column title="操作" width="450px" fixed="right" align="center">
              <template slot-scope="scope">
