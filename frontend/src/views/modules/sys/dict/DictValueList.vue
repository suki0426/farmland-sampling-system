<template>
  <div style="padding:10px" class="container-custom-dialog">
          <vxe-toolbar :refresh="{query: refreshList}"  custom>
            <template #buttons>
              <el-button type="primary" size="small" icon="el-icon-plus" @click="add()" class="mr-2">新建</el-button>
...
.container-custom-dialog * .vxe-table--render-default .vxe-table--body-wrapper {
    height: 100%!important;
}
.container-custom-dialog.el-dialog__wrapper {
    height: 90%!important;
}
</style>
