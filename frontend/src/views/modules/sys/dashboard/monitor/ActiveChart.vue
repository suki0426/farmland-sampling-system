...
import { getCurrentThemeColor, hexToRgba, mixHexColors } from '@/utils/themeColor'
...
export default {
  ...
  computed: {
    ...
    themeAreaColor () {
      return hexToRgba(this.themeColor, 0.2)
    },
    themeBorderColor () {
      return mixHexColors(this.themeColor, '#020617', 0.08)
    },
    options () {
      return {
        grid: {
        ...
        series: [
          {
            ...
            smooth: true,
            itemStyle: {
              color: this.themeAreaColor,
              shadowColor: this.themeAreaColor,
              shadowBlur: 15,
              borderWidth: 1,
              borderColor: '#fff'
            },
