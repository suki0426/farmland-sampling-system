    ...
    <el-row :gutter="10" style="margin-bottom: 10px">
      ...
      <el-col :lg="6" :md="12" :sm="24" :xs="24">
        <el-card
          header="资源剩余"
        >
          <ve-liquidfill height="126px" :series="resourceLiquidSeries"></ve-liquidfill>
        </el-card>
      </el-col>
    </el-row>
  </div>
...
import { getCurrentThemeColor, mixHexColors } from '@/utils/themeColor'
...
export default Vue.extend({
  ...
  computed: {
    themeColor () {
      return this.$store.state.config.defaultTheme || getCurrentThemeColor()
    },
    couponGaugeSeries () {
      return [
        {
          ...
          axisLine: {
            lineStyle: {
              color: [[0, this.themeColor], [80 * 0.01, this.themeColor], [1, '#F0F2F5']],
              width: 10
            }
          },
          splitLine: {
      ...
      return [
        {
          ...
          outline: {
            ...
            itemStyle: {
              borderWidth: 2,
              borderColor: mixHexColors(this.themeColor, '#020617', 0.08)
            }
          },
          backgroundStyle: {
            color: '#fff',
