<template>
    ...
    <div class="jp-common-layout-center jp-flex-main">
      <el-form :inline="true" size="small" class="ultra-query-form" ref="searchForm" :model="searchForm" @keyup.enter.native="refreshList()" @submit.native.prevent>
            <!-- 搜索框-->
  ...
  methods: {
    ...
    delTreeNode (data) {
      this.$confirm(`确定删除所选项吗?`, '提示', {
        ...
        this.loading = true
        docCategoryService.delete(data.id).then(({ data }) => {
