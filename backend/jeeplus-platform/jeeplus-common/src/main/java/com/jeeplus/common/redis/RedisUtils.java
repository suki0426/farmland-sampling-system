...
public class RedisUtils {
    ...
    public static RedisUtils getInstance() {
        return SpringUtil.getBean ( RedisUtils.class );
    }


    /** ------------------------常用操作------------------------------- **/

    /**强烈推荐使用常规操作的api，使用其它的api将导师注解@CacheEvict,@Cacheable无效**/
    /**
     * 获取缓存
     *
     * @param cacheName
    ...
    public Object get(String cacheName, String key) {
        return this.get ( String.format ( "%s::%s", cacheName, key ) );
    }
    ...
    public void set(String cacheName, String key, Object value) {
        this.set ( String.format ( "%s::%s", cacheName, key ), value );
    }
    ...
    public void delete(String cacheName, String key) {
        this.delete ( String.format ( "%s::%s", cacheName, key ) );
    }

    public Boolean expire(String cacheName, String key, long timeout) {
        return redisTemplate.expire ( String.format ( "%s::%s", cacheName, key ), timeout, TimeUnit.SECONDS );
    }
    ...
    public Set <String> keys(String cacheName, String pattern) {
        return redisTemplate.keys ( String.format ( "%s::%s", cacheName, pattern ) );
    }
    /** -------------------key相关操作--------------------- */
