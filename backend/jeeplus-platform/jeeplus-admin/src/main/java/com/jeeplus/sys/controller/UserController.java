...
import com.jeeplus.sys.service.vo.UserVO;
...
public class UserController {
    ...
    public ResponseEntity savePwd(@RequestBody UserVO userVO) {
        String key = "quanquankejigong"; // 替换为你自己的密钥
        String oldPassword = decrypt(userVO.getOldPassword(), key);
        String newPassword = decrypt(userVO.getNewPassword(), key);
