...
public class SmsUtils {
    ...
    // 短信服务访问凭据由系统配置或环境变量提供，禁止在源码中硬编码。
//    static final String accessKeyId = System.getenv("SMS_ACCESS_KEY_ID");
//    static final String accessKeySecret = System.getenv("SMS_ACCESS_KEY_SECRET");
